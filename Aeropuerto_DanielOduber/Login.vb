Public Class Login
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If usuario.Equals("admin") AndAlso contrasena.Equals("johan_gay") Then
            ...
            Dim pasar_Al_Menu_admin As New Form_Menu()
        ...
        ElseIf usuario.Equals("usuario") AndAlso contrasena.Equals("yosiney_Guapo") Then
            ...
            pasar_Al_Menu_usuario.StartPosition = FormStartPosition.Manual ' Se establece la posición manualmente
            ' Se establece la posición inicial del formulario en las coordenadas deseadas
            pasar_Al_Menu_usuario.Location = New Point(200, 170) ' Aqui pusimos lo que fue la posicion inicial de la ventana login
